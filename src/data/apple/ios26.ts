...
// iOS 26 — Liquid Glass design, same settings structure as iOS 18 with additions
const iosTheme = {
  style: 'ios' as const,
      ...
      children: [
        { id: 'wifi_toggle', label: 'Wi-Fi', type: 'toggle', value: true, dividerAfter: true },
        {
          ...
          children: [
            ...
            { id: 'wifi_private_address', label: 'Private Wi-Fi Address', type: 'toggle', value: true, subtitle: 'Use a different Wi-Fi address for this network to reduce tracking.' },
            { id: 'wifi_limit_tracking', label: 'Limit IP Address Tracking', type: 'toggle', value: false },
            { id: 'wifi_forget', label: 'Forget This Network', type: 'destructive' },
          ],
        },
        { id: 'wifi_other_networks_header', label: 'OTHER NETWORKS', type: 'info', dividerAfter: true },
        {
          id: 'ask_to_join',
          ...
          children: [
            ...
            { id: 'notify_on', label: 'Notify', type: 'action' },
      ...
      children: [
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                { id: 'dm_standard', label: 'Standard', type: 'action' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'maximize_compat', label: 'Maximize Compatibility', type: 'toggle', value: false, subtitle: 'Hotspot uses 2.4 GHz Wi-Fi for better compatibility. This may reduce iPhone\'s internet speed.' },
          ],
        },
        {
          id: 'carrier_lock',
          label: 'Carrier Lock',
          type: 'value',
          value: 'No SIM Restrictions',
        },
        {
          id: 'esim_management',
          label: 'eSIM Management',
          type: 'menu',
          children: [
            { id: 'esim_primary', label: 'Primary — Carrier SIM', type: 'value', value: 'Active' },
            { id: 'esim_add', label: 'Add eSIM', type: 'action' },
          ],
        },
        {
        ...
        },
        {
          ...
          type: 'menu',
          children: [
            { id: 'satellite_info', label: 'Reach emergency services when outside cellular and Wi-Fi coverage.', type: 'info' },
          ],
        },
        {
          id: 'sim_pin',
          ...
          type: 'menu',
          children: [
            { id: 'sim_pin_toggle', label: 'SIM PIN', type: 'toggle', value: false },
          ],
        },
        {
          id: 'sim_apps',
          ...
          dividerAfter: true,
          children: [
            { id: 'sim_info', label: 'SIM Toolkit', type: 'info' },
          ],
        },
      ],
    },
