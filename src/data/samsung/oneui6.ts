  ...
  settings: [
    {
      ...
      children: [
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                { id: 'auto_reconnect', label: 'Auto reconnect', type: 'toggle', value: true },
              ],
            },
          ],
        },
        ...
        { id: 'airplane', label: 'Airplane mode', type: 'toggle', value: false },
        {
          ...
          label: 'SIM manager',
          type: 'menu',
          subtitle: 'Manage SIM cards and dual SIM settings',
          dividerAfter: true,
          children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'volte', label: 'VoLTE calls', type: 'toggle', value: true, subtitle: 'Use LTE network for voice calls.' },
          ],
        },
        {
          id: 'data_usage',
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'hotspot_config', label: 'Mobile Hotspot', type: 'menu', children: [
              { id: 'hotspot_name', label: 'Network name', type: 'value', value: 'Galaxy S24 Hotspot' },
