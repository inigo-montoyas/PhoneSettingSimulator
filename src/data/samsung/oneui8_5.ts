...
export const oneui8_5: OSConfig = {
  id: 'oneui8_5',
  vendor: 'samsung',
  osName: 'One UI',
  version: '8.5',
      ...
      children: [
        {
          ...
          children: [
            { id: 'wifi_toggle', label: 'Wi-Fi', type: 'toggle', value: true },
            {
              ...
              badge: '✓',
              children: [
                { id: 'wifi_speed', label: 'Speed', type: 'value', value: 'Fastest (Wi-Fi 7)' },
            ...
            },
            {
              ...
              children: [
                ...
                { id: 'smart_switch', label: 'Switch to mobile data', type: 'toggle', value: true, subtitle: 'Automatically switch when Wi-Fi is unstable.' },
                { id: 'wifi7', label: 'Wi-Fi 7', type: 'toggle', value: true, subtitle: 'Enable Wi-Fi 7 for faster speeds.' },
        ...
        },
        {
          ...
          children: [
            ...
            { id: 'hotspot_config', label: 'Mobile Hotspot', type: 'menu', children: [
              { id: 'hotspot_name', label: 'Network name', type: 'value', value: 'Galaxy Hotspot' },
